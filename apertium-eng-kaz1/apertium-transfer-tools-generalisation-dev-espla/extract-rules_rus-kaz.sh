...
#DEFINE_string 'monolingual_dic_source' '/home/apertium/apertium-testing/apertium-rus/apertium-rus.rus.dix' 'Monolingual dictionary for source language'
#DEFINE_string 'monolingual_dic_target' '/home/apertium/apertium-testing/apertium-kaz/apertium-kaz.kaz.lexc' 'Monolingual dictionary for target language'
DEFINE_string 'corpus' '/home/apertium/apertium-testing/apertium-kaz-rus/texts/texts' 'prefix of files containing parallel corpus (suffixes are .SL and .TL)' 'c'
DEFINE_string 'giza_dir' '/home/apertium/giza-pp/GIZA++-v2' 'Giza++ directory' 'g'
DEFINE_string 'data_dir' '/home/apertium/apertium-testing/apertium-kaz-rus' 'Directory where the source and compiled Apertium dictionaries can be found (default: /usr/local/share/apertium/apertium-SL-TL/)' 'd'
DEFINE_string 'apertium_prefix' '/usr/local' 'Prefix where Apertium was installed (default: /usr/local/)' 'u'
######################
# (optional)
...
######################
DEFINE_string 'tmp_dir' '/home/apertium/apertium-testing/apertium-rus-kazNEW' 'temporary directory' 'm'
...
DEFINE_string 'test_corpus' '/home/apertium/apertium-testing/apertium-kaz-rus/texts/test' 'evaluation corpus prefix (suffixes are .SL and .TL)' 'e'
DEFINE_string 'dev_corpus' '/home/apertium/apertium-testing/apertium-kaz-rus/texts/dev' 'development corpus prefix (suffixes are .SL and .TL). It is used to choose the most appropriate threshold' 'v'
...
DATADIR3="/home/apertium/apertium-testing/apertium-$SL/"
 
#find monolingual .dix files
if [ -f $DATADIR3/.deps/$SL.dix ] ; then
	MONODIXL1=$DATADIR3/.deps/$SL.dix
elif [ -f $DATADIR3/apertium-$SL.$SL.dix ]; then
	MONODIXL1=$DATADIR3/apertium-$SL.$SL.dix
else
...
if [ "${FLAGS_transfer_tools_1}" == "${FLAGS_TRUE}" ]; then
  ...
  if [ "${FLAGS_only_extract_bilingual_phrases}" != "${FLAGS_TRUE}" ]; then
    ...
    APERTIUMPREFIXDATADIR="/home/apertium/apertium-testing/apertium-kaz-rus"
