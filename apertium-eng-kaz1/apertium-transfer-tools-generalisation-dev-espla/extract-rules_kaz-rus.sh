...
DEFINE_string 'source_language' 'kaz' 'source language' 's'
DEFINE_string 'target_language' 'rus' 'target language' 't'
DEFINE_string 'monolingual_dic_target' '/home/apertium/apertium-testing/apertium-rus/apertium-rus.rus.dix' 'Monolingual dictionary for source language'
DEFINE_string 'monolingual_dic_source' '/home/apertium/apertium-testing/apertium-kaz/apertium-kaz.kaz.lexc' 'Monolingual dictionary for target language'
...
######################
DEFINE_string 'tmp_dir' '/home/apertium/apertium-testing/apertium-kaz-rusNEW' 'temporary directory' 'm'
...
if [ "${FLAGS_data_dir}" == "" ]; then
  DATADIR="/home/apertium/apertium-testing/apertium-$APERTIUMPAIR/"
else
