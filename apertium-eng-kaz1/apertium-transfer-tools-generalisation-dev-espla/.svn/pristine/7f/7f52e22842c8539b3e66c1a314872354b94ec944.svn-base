...
echo "zcat $INPUTDIR/maximise-score-$FILTERING_OPTION/rulesid-f-${treshold}.gz"
...
echo "$DIR/tuning-$TUNING_ID/subrules/sortedboxesindex-$treshold"
		  else
