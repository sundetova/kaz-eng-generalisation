...
DEFINE_string 'filtering_thresholds' '1_-0.05_0' 'Filtering thresholds to test' 'F'
...
WAIT_INTERVAL=20
NUMGEN=`find  $RESULTS_DIR -maxdepth 1 -name 'generalisation-*.tar.gz' | wc -l`
NUMPARTS=$((NUMGEN - 1))

NUMTHRESHOLDS=`seq $THRESHOLD_START $THRESHOLD_STEP $THRESHOLD_END | wc -l`
...
THRESHOLDS_ARRAY=()
for THRESHOLD in `seq $THRESHOLD_START $THRESHOLD_STEP $THRESHOLD_END`; do
