...
FILTERINGNAME="reftobilingpaperexplicit"

#create dir
#ssh euler.iuii.ua.es "mkdir -p /home/vmsanchez/data/input/$PAIR/$BILID/; ln -s /home/vmsanchez/data/input/$PAIR/$BILID /home/vmsanchez/data/input/$PAIR/$BILID-$FILTERINGNAME"
