...
bool TransferRule::do_rbpe=false;
...
TransferRule::gen_apertium_transfer_foot(bool debug) {
  ...
  foot+=L"    <lu>\n";
  if(do_rbpe){
  foot+=L"      <clip pos=\"1\" side=\"sl\" part=\"whole\"/>\n";
  } 
  else {
  ...
  foot+=L"<rule>\n";
  foot+=L"<pattern><pattern-item n=\"CAT__HASGENDER_NUMBER\"/></pattern><action> <call-macro n=\"f_genre_num\"><with-param pos=\"1\"/></call-macro> <call-macro n=\"f_set_genre_num\"><with-param pos=\"1\"/></call-macro> <out><lu>";
  if(do_rbpe){
	  foot+=L"<clip pos=\"1\" side=\"sl\" part=\"whole\"/>";
  }
  else {
  ...
  foot+=L"</lu></out> </action><!--isolated word-->\n";
  foot+=L"</rule>\n";
  
  foot+=L"<rule>\n";
  foot+=L"<pattern><pattern-item n=\"sent\"/></pattern><action> <let><var n=\"number\"/> <lit-tag v=\"sg\"/></let><let><var n=\"genre\"/><lit-tag v=\"m\"/></let> <out><lu>";
  if(do_rbpe){
  foot+=L"<clip pos=\"1\" side=\"sl\" part=\"whole\"/>";
  }
  else{
  ...
  foot+=L"<rule>\n";
  foot+=L"<pattern><pattern-item n=\"any\"/></pattern><action>  <out><chunk name=\"any\" case=\"caseFirstWord\"><tags>             <tag><lit-tag v=\"LRN\"/></tag>       </tags>   <lu>";
  if(do_rbpe){
	  foot+=L"<clip pos=\"1\" side=\"sl\" part=\"whole\"/>";
  }
  else{
  ...
  foot+=L"</lu></chunk></out> </action><!--isolated word-->\n";
  foot+=L"</rule>\n";
