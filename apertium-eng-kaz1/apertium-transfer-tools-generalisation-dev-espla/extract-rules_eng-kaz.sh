...
DEFINE_string 'monolingual_dic_source' '/home/apertium/apertium-testing/apertium-eng-kaz/apertium-eng-kaz.eng.dix' 'Monolingual dictionary for source language'
...
DEFINE_string 'corpus' '/home/apertium/apertium-testing/apertium-eng-kaz/texts/corpus1' 'prefix of files containing parallel corpus (suffixes are .SL and .TL)' 'c'
...
DEFINE_string 'test_corpus' '/home/apertium/apertium-testing/apertium-eng-kaz/texts/test' 'evaluation corpus prefix (suffixes are .SL and .TL)' 'e'
DEFINE_string 'dev_corpus' '/home/apertium/apertium-testing/apertium-eng-kaz/texts/dev' 'development corpus prefix (suffixes are .SL and .TL). It is used to choose the most appropriate threshold' 'v'
...
DEFINE_string 'corpus_head_size' '4355' 'size (in lines) of the prefix of the corpus to use' 'a'
...
if [ "${FLAGS_transfer_tools_1}" == "${FLAGS_TRUE}" ]; then
  ...
  if [ "${FLAGS_only_extract_bilingual_phrases}" != "${FLAGS_TRUE}" ]; then
    ...
    APERTIUMPREFIXDATADIR="/home/apertium/apertium-testing/apertium-eng-kaz"
