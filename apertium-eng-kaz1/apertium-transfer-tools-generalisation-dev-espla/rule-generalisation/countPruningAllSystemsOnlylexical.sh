...
if [ "$PARSIZE" == "" -o "$PARSIZE" == "$SIZE"  ]; then
...
#download filtering
scp euler.iuii.ua.es:/home/vmsanchez/results/experiments-linear-l5-${SL}-${TL}/$BILID/shuf$SIZE/filtering-$FILTERINGNAME-*-f-0.tar.gz ./
